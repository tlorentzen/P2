...
namespace CompleteTest{
    public class FileEncryption{
        ...
        public void doEncrypt(string hashInput){
            //Try to Catch FileNotFoundException
            try{
                ...
                byte[] passwordBytes = System.Text.Encoding.UTF8.GetBytes(hashInput);
                ...
                Console.WriteLine("The file was not found, exiting" + e);
            }
        }

        public void doDecrypt(string hashInput, string outputPath){
            ...
            FileStream fsCrypt = new FileStream(this._path + this._extension, FileMode.Open);
